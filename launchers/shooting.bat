@echo off
chcp 65001 > nul
title yampf926 - 슈팅 게임
echo.
echo [슈팅 게임]
echo 이 파일은 yampf926 프로젝트가 있는 PC에서 실행해야 함.
echo.
if not exist "C:\Users\KOSMO\IdeaProjects\yampf926\src\shootingGame" (
    echo 프로젝트 폴더를 찾지 못함.
    echo C:\Users\KOSMO\IdeaProjects\yampf926\src\shootingGame
    echo.
...
cd /d "C:\Users\KOSMO\IdeaProjects\yampf926\src\shootingGame"
echo 슈팅 게임 컴파일 중...
