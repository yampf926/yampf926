...
echo.
if not exist "C:\Users\KOSMO\IdeaProjects\yampf926\src\sudoku" (
    echo 프로젝트 폴더를 찾지 못함.
    echo C:\Users\KOSMO\IdeaProjects\yampf926\src\sudoku
    echo.
...
cd /d "C:\Users\KOSMO\IdeaProjects\yampf926\src\sudoku"
echo 스도쿠 컴파일 중...
