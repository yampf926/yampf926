@echo off
chcp 65001 > nul
title yampf926 - 탈출 게임
echo.
echo [탈출 게임]
echo 이 파일은 yampf926 프로젝트가 있는 PC에서 실행해야 함.
echo.
if not exist "C:\Users\KOSMO\IdeaProjects\yampf926\src\escape" (
    echo 프로젝트 폴더를 찾지 못함.
    echo C:\Users\KOSMO\IdeaProjects\yampf926\src\escape
    echo.
...
cd /d "C:\Users\KOSMO\IdeaProjects\yampf926\src\escape"
echo 탈출 게임 컴파일 중...
